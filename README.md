...
Setup reads the app database and role from the project `.env` (existing process
...
The first command runs protocol and IndexedDB regression tests. The second uses the
